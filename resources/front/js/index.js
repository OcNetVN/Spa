...
function showdetailpro_complete(data) { 
    ...
    if (sRes !== null) {
        ...
        if (pro != null) {
            var linkpro = "../productdetail/index/" + pro.ProductID;
			$("#fb_comments_count").attr("data-href",linkpro);
            $("#fb_commentsshow").attr("data-href",linkpro);
            ...
            $("#divProductDetail0short").html(description.substr(0,150));
        ...
        if (spa != null) {
            var link = "spadetail/index/" + spa.spaID;
