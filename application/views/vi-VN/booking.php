                    ...
                    <div class="content">
                        ...
                        <div class="" style="background:white; color:black; padding:7px;">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                              ...
                              <li><a href="#reviews-popup" role="tab" data-toggle="tab">Đánh giá(<span id="fb_comments_count" class="fb-comments-count" data-href=""></span>)</a></li>
                            ...
                            <div class="tab-content">
                              ...
                              <div class="tab-pane active" id="overview-popup">
                                    ...
                                    <h3 style="font-weight:bold;">Thời gian dịch vụ: <span class="spanProductDuration" style="font-size:24px;">00</span> Phút</h3>

                                    <h3 style="font-weight:bold;">Giá dịch vụ: <span class="spanProductPrice" style="color: #12a5c9; font-weight: bold;font-size:24px;"></span></h3>
                                    <h3 style="display: none;font-weight:bold;" id="divsaveprice">Giá khuyến mãi: <span id="spanProductSavePrice" style="color: #F96060; font-weight: bold;font-size:24px;"></span></h3>
                                    
                                    <div id="divshortinfo">
                                        <h3 style="font-weight:bold;">Thông tin dịch vụ</h3>
                              ...
                              <h4>Vui lòng xem hướng dẫn đặt chỗ ở đây</h4>
