...
<header>
    ...
    <div class="full-bar wrap-banner" style="background-image:url(<?php echo base_url('resources/front/images/banner1.jpg'); ?>);">
        <div class="wrap-quick-booking">
            <div class="container">
                <h2 class="banner-title">RESERVATION SYSTEM SPA & BEAUTY SALON FIRST IN VIETNAM<br />WITH MORE THAN 1000 SERVICE IS UPDATED EVERY DAY</h2>
                <ul class="nav nav-tabs quick-booking-tab" role="tablist">
                  <li class="active"><a href="#book-treatment" role="tab" data-toggle="tab">Booking</a></li>
                  <li><a href="#spa-day" role="tab" data-toggle="modal" data-target="#specialofferModal">Promotion</a></li>
                </ul>
                      ...
                      <form class="form" role="form">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 wrap-control">
                            ...
                            <div class="input-group">
                              ...
                              <input id="txtProductTypeSearch" class="form-control" type="text" placeholder="You are looking for what services?" value="">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6 wrap-control">
                            <div class="form-group">
                                <div class="input-group">
                                  ...
                                  <input id="txtLocationSearch" class="form-control" type="text" placeholder="Select location">
                                </div>
                              </div>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-6 wrap-control">
                            <div class="form-group">
                                <div class="input-group">
                                  ...
                                  <input id="txtDateSearch" class="form-control datepicker" type="text" placeholder="Select date">
                                </div>
                            </div>
                        </div>
                        
                        <div class="col-md-2 col-sm-2 col-xs-12 wrap-control">
                            <button type="button" class="btn btn-default" onclick="Search3();">Search</button>
                        </div>
                        </div>
                    </form>
                  </div>
    ...
    <!-- InstanceBeginEditable name="Main Content" -->
                               ...
                               <?php }else{  ?>
                                ...
                                <!--<div class="active item">-->
                                    ...
                                    <div class="wrap-thumb1" style="background-image:url(<?php $imglnk = $this->m_news->laylinkImages($listnew[$i]->id);echo $imglnk;?>);background-size: 541px 200px;"></div>  
                                     ...
                                     <div class="wrap-buttons"><form method="GET" action="<?php echo base_url($urlnews); ?>"><input type="hidden" value="<?php echo $HotNews['News']->id; ?>" /><button type="submit" class="btn btn-default btn-grey" >View Detail</button></form></div>
                                </div> 
                         <?php }?>
                    </div>
        ...
        <h1 class="title">Quick hands up promotions service options to 50%</h1>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Product Promotion</h4>
      </div>
