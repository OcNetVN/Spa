<ul class="nav nav-pills nav-stacked nav-leftmenu">
  ...
  <li role="presentation" class="active " id="menu_about"><a href="<?php echo base_url('/about');?>">About thebooking.vn</a></li>

  <li role="presentation" id="menu_contact"><a href="<?php echo base_url('/contact');?>">Contact</a></li>

  <li role="presentation" id="menu_hiring"><a href="<?php echo base_url('/hiring');?>">For Partners</a></li>
