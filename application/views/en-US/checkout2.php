                             ...
                             <div class="col-md-12" id="divinfospa" style="display: none;">
                                 ...
                                 <?php 
                                    foreach($_SESSION['Cart'] as $row_cartspa)
                                    {
                                            ...
                                            echo '<tr>';
                                                echo '<td>';
                                                    echo "Spa: <span style=\"font-weight: bold;\">".$spaName."</span><br />";
                                                    echo "Address: <span style=\"font-weight: bold;\">".$Address."</span><br />";
                                                    echo "Phone: <span style=\"font-weight: bold;\">".$Tel."</span><br />";
            ...
            <div class="col-md-3" id="idpricecode">
                    <?php
                        if(isset($_SESSION['Cart']))
                        {
                            ...
                            echo '<h4><strong>Total Amount: '.number_format($tongtien).' VNĐ</strong></h4>';
                        }
                        if(isset($_SESSION['discount']))
                        {
                            $tongtien=0;
                        ...
                        echo "Discount: ".number_format($DiscountAmt)." VNĐ<br />";
                        echo '<h4>Pay: '.number_format($tongtien-$DiscountAmt).' VNĐ</h4>';
