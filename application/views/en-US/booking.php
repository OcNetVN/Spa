...
<div class="modal fade" id="serviceModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: 999999999;">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">
            ...
            <span class="spanSpaName" id="spanSpaNameModalLabelService">
                ...
                Spa at Thorpe Park Hotel & Spa, a Shire Hotel
          ...
          <div class="product-top-box box-padding">
            ...
            <h1 class="title">
               ...
               <a href="" id="linkproductID" style="color:white;font-weight: bold;">
                ...
                <span id="spanProductName">Tea and Pamper Spa Day</span> 
            ...
            <div class="wrap-2cols spa-detail-popup">
                ...
                <div class="col-content">
                    ...
                    <div class="content">
                        ...
                        <div class="" style="background:white; color:black; padding:7px;">

                            <ul class="nav nav-tabs" role="tablist">

                              <li class="active"><a href="#overview-popup" role="tab" data-toggle="tab">Details</a></li>                          
                              <li><a href="#reviews-popup" role="tab" data-toggle="tab">Evaluation(<span id="fb_comments_count" class="fb-comments-count" data-href=""></span>)</a></li>
                            ...
                            <div class="tab-content">
                              ...
                              <div class="tab-pane active" id="overview-popup">
                                    ...
                                    <h3 style="font-weight:bold;">Time: <span class="spanProductDuration" style="font-size:24px;">00</span> min</h3>

                                    <h3 style="font-weight:bold;">Price: <span class="spanProductPrice" style="color: #12a5c9; font-weight: bold;font-size:24px;"></span></h3>
                                    <h3 style="display: none;font-weight:bold;" id="divsaveprice">Promoton Price: <span id="spanProductSavePrice" style="color: #F96060; font-weight: bold;font-size:24px;"></span></h3>
                                    ...
                                    <div id="divfullinfo" style="display: none;">
                                        <h3 style="font-weight:bold;">Information Services</h3>
                                        <p id="divProductDetail0">Lift your spirits without lifting a finger...</p>
                                        <h4>Service Policy</h4>
                                        <p id="divProductDetail1">Lift your spirits without lifting a finger...</p>
                                        <h4>Other terms</h4>
                                        <p id="divProductDetail2">Lift your spirits without lifting a finger...</p>
                                        <h4>Care therapy</h4>
                                        <p id="divProductDetail3">Lift your spirits without lifting a finger...</p>
                                    </div>
                              </div>
                              ...
                              <h4>Please see the guide book here</h4>

                              <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='http://www.youtube.com/embed/hMETFLB852g' frameborder='0' allowfullscreen></iframe></div>
                              ...
                              <div class="tab-pane" id="venue-popup">
                                ...
                                <h3 class="section-title-filter"><span class="spanSpaName">THE SPA AT NORTH LAKES HOTEL</span></h3>
                                    ...
                                    //init_map(11.11, 11.11, "loc_content");
                              ...
                              <div class="tab-pane" id="reviews-popup">
                                    ...
                                    <!-- <h6 style="font-weight:bold;">
                                      <span class="fb-comments-count" data-href="" id="fb_comments_count"></span><b>comments</b>
                                    </h6> -->
                                    <div class="fb-comments"  data-href="" data-numposts="5" data-colorscheme="light" id="fb_commentsshow" ></div>
                                    <button class="btn btn-default pull-right" onclick="$('#wrap-add-comment-popup').toggle(300);">Enter comment</button>
                                       ...
                                       <!-- <div class="wrap-2cols nav-left wrap-review">
                                            ...
                                            <div class="col-content">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="2" id="tblCommentProduct">
                ...
                <div class="col-nav"> 
                    ...
                    <button id="btnBackToChooseDay" value="Back" style="display: none;" onclick="BackToChooseDay();">Reselect</button>
                          ...
                          <div class="form-group" id="ChooseDateBooking" style="display: none;">
                            ...
                            <div class="input-group" style="display: none;">
                              ...
                              <div class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></div>                              
                                ...
                                <input readonly="readonly" id="txtSelectedDay" class="form-control" type="text" value="">
...
<!--<div id="divPopupAdv" class="divPopupAdv" style="display: none;">

    <img src="<?php //echo base_url('resources/front/images/Ads/advertising.png'); ?>" />
