        ...
        <header>
            ...
            <div id="bookmark1" name="bookmark1" class="container" style="padding-top:10px; padding-bottom:10px;">
                ...
                <h1 class="page-title-resut">
                    <div class="row">
                        <div class="col-md-8">
                            <p style="padding-top: 6px;padding-left: 10px;">Found <span id="tongmautin"><?php if(isset($listspa)) echo $listspa['tongmautin']; ?></span> results</p>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="wrap-2cols nav-left product-category">
                    <div class="col-nav">
                        <h2 class="section-title">Search by results</h2>
                        <div class="section-filter">
                            <h3 class="section-title-filter">Time - Location</h3>
                            <div class="filters">
                                <div class="form-group">
                        ...
                        <?php
                            ...
                            <div class="section-filter"> <!--tien ich spa-->
                                <h3 class="section-title-filter">Utilities Spa</h3>
                                <div class="filters">
                                    <?php 
                        ...
                        <?php
                            ...
                            <div class="section-filter"> <!--loai spa spa-->
                                <h3 class="section-title-filter">Kinds Spa</h3>
                                <div class="filters">
                                    <?php 
                        ...
                        <div class="section-filter">
                            <h3 class="section-title-filter">Price services</h3>
                            <div class="filters">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-4 control-label">Pages:</label>
                                                    <div class="col-sm-8">
