...
<head>
    ...
    <meta property="og:url" content="<?php echo $link_spainfo; ?>" />
                                                    ...
                                                    echo '<table class=" table table-striped table-hover wrap-product-lists" width="100%" border="0" cellspacing="0" cellpadding="5">';
                                                        ...
                                                        foreach($list_pro as $row_list_pro)
                                                        {
                                                            ...
                                                            if(count($listPromo) > 0)
                                                            {
                                                                ...
                                                                echo '<td class="item-discount" style="color: #12a5c9;font-weight:bold;font-size:13px;">'.number_format($listPromo[0]->Price).' VNĐ <span class="savings" style="color:red;"><img width="40%" src="'.base_url("resources/front/images/discount.png").'"><span class="title"></span><span class="value" style="font-size:18px;font-weight:bold;">'.$savepercent.'%</span></span></td>';
                                                                ...
                                                                echo '<td class="item-discount" style="color: #12a5c9;font-weight:bold;font-size:13px;">'.number_format($row_list_pro->Price).' VNĐ</td>';
