            ...
            <div class="col-md-8">
                    <?php
                        ...
                        foreach($list_info_session as $row_info)
                        {
                            ...
                            echo '<h4>Spa: '.$row_info['spa']->spaName.'</h4>';
                            echo '<p>Address: '.$row_info['spa']->Address.'</p>';
                            echo '<p>Phone: '.$row_info['spa']->Tel.'</p>';
                            ...
                            echo '<div class="wrap-table">';
                                ...
                                echo '<tr>';
                                      echo '<td colspan="5" align="right"><span style="font-size:15px;"><strong>Total amount spa '.$row_info['spa']->spaName.':</strong></span></td>';
...
//                        die();
                        if(isset($_SESSION['Cart']))
                        {
                            ...
                            echo '<h4><strong>Total amount: <span id="totalPricecode">'.number_format($tongtien).'</span> VNĐ</strong></h4>';
                        }
                    ?>
                        <div id="divdiscount" <?php if(!isset($_SESSION["AccUser"]) && !isset($_SESSION["object"])) echo 'style="display:none;"'; ?>>
                            <div id="inputdiscount">
                                <h4>Code discount card</h4>
                                <label><input type="radio" name="disccode" value="4" checked="checked"/>Do not apply</label><br />
                                <label><input type="radio" name="disccode" value="1" />Members Code</label><br />
                                <label><input type="radio" name="disccode" value="2" />Discount Code</label><br />
                                <label><input type="radio" name="disccode" value="3"/>Score</label><br />
                                <label><input type="radio" name="disccode" value="5"/>Residual amount</label><br />
                                <div id="divusecode" style="display: none;">
                                    <input type="text" class="form-control" id="txtcardcode" />
                                    <p id="pcodeid" style="display: none;"><label>code: </label><input type="text" class="form-control" id="txtgenerated" /></p>
                                    ...
                                    <button type="button" class="btn btn-danger" id="applycode" onclick="applycodediscount();">confirm</button>
                                </div>
                                <div id="divusepoint" style="display: none;">
                                    <label style="color: red;">1 point = 
                                    <?php 
                                    ...
                                    if(isset($pointtomoneymember) && count($pointtomoneymember)>0)
                                        ...
                                        echo $ScoreRate;
                                    ?> VNĐ</label><br />
                                    <label>You have <span id="havepoint">0</span> point</label>
                                    <span id="hidehavepoint" style="display: none;"></span><br />
                                    <label style="width:100%;"><label>You want to use </label><input type="text" class="form-control" id="inputpoint" /> <label> point</label></label><br />
                                    ...
                                    <button type="button" class="btn btn-danger" id="applypoint" onclick="applypointdiscount();">confirm</button>
                                </div>
                                <div id="divuseoutstanding" style="display: none;">
                                    <label>You have <span id="haveoutstanding">0</span> VNĐ</label>
                                    <span id="hidehaveoutstanding" style="display: none;"></span><br />
                                    <label style="width:100%;"><label>You want to use </label><input type="text" class="form-control" id="inputoutstanding" />*1000 <label> VNĐ</label></label><br />
                                    <p id="erroutstanding" style="display: none; color: red;"></p>
                                    <button type="button" class="btn btn-danger" id="applyoutstanding" onclick="applyoutstandingdiscount();">confirm</button>
                                </div>
          ...
          <div id="divcontentnull" style="display: none;"><h2 style="margin: 30px;">No data, please reload page</h2></div>
